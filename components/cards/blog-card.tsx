...
export const BlogCard = ({ post }: { readonly post: BlogPost }) => (
  <article className="rounded-[2rem] border border-fume-primary/10 bg-white p-6 shadow-card fume-motion-card transition hover:-translate-y-1 hover:shadow-soft">
