...
export const metadata = createMetadata({
  ...
  description: "Privacy policy for Fume Coworking website visitors and customers.",
  path: "/privacy-policy/"
});
...
export const LegalPage = () => (
  <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
    ...
    <h1 className="mt-4 font-heading text-4xl font-black text-fume-charcoal">Privacy Policy</h1>
