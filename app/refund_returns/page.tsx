...
export const metadata = createMetadata({
  ...
  description: "Refund and returns policy for Fume Coworking bookings and services.",
  path: "/refund_returns/"
});
...
export const LegalPage = () => (
  <section className="mx-auto max-w-4xl px-4 py-20 sm:px-6 lg:px-8">
    ...
    <h1 className="mt-4 font-heading text-4xl font-black text-fume-charcoal">Refund and Returns Policy</h1>
